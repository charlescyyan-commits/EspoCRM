...
Current packaged extension version: **`1.9.13-alpha`** (`crm-extension/manifest.json`).
...
- [../release/RELEASE_NOTES_1.9.13-alpha.md](../release/RELEASE_NOTES_1.9.13-alpha.md) (current package notes)
