...
Current packaged extension version: **`1.9.11-alpha`** (`crm-extension/manifest.json`).
...
- [../release/RELEASE_NOTES_1.9.11-alpha.md](../release/RELEASE_NOTES_1.9.11-alpha.md) (current package notes)
