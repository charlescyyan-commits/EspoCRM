...
|-------|---------------|----------|
| `version` | `1.9.11-alpha` | `crm-extension/manifest.json` |
| `releaseDate` | `2026-07-26` | `crm-extension/manifest.json` |
...
|----------|---------|---------|
| Extension ZIP | `prospecting-extension-<semver>.zip` | `prospecting-extension-1.9.11-alpha.zip` |
