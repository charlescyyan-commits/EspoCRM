...
|-------|---------------|----------|
| `version` | `1.9.5-alpha` | `crm-extension/manifest.json` |
| `releaseDate` | `2026-07-13` | `crm-extension/manifest.json` |
...
|----------|---------|---------|
| Extension ZIP | `prospecting-extension-<semver>.zip` | `prospecting-extension-1.9.5-alpha.zip` |
...
For the current package, the ZIP and manifest are aligned at `1.9.5-alpha`; the SHA-256 sidecar is still a release-hygiene follow-up and must not be represented as present.
