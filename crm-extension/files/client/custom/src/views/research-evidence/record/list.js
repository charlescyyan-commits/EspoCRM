Espo.define('custom:views/research-evidence/record/list', 'views/record/list', function (Dep) {
    return Dep.extend({
        emptyStateText: 'Website research results will appear after prospects are analyzed.',
