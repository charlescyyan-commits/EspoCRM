...
class Phase3C17CC0BProvisioningHardeningTests(unittest.TestCase):
    ...
    def test_repeated_execution_does_not_duplicate_command_center_tab(self) -> None:
        ...
        ids = re.findall(r"'id' => '((?:phase3c17|phase3c18|phase3c19)-command-[^']+)'", self.source)
        ...
        self.assertIn("phase3c19-command-failed-send", ids)
        self.assertIn("phase3c19-command-open-replies", ids)
        self.assertIn("phase3c19-command-my-replies", ids)
