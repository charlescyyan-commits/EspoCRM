...
class ExtensionSkeletonTests(unittest.TestCase):
    ...
    def test_only_standard_research_evidence_php_shells_exist(self) -> None:
        ...
        expected = {
            ...
            MODULE / "Entities" / "AIQualificationInsight.php",
            MODULE / "Entities" / "HumanFeedback.php",
            MODULE / "Controllers" / "ResearchEvidence.php",
            MODULE / "Services" / "ResearchEvidenceService.php",
            MODULE / "Services" / "ResearchEvidenceGovernanceService.php",
            MODULE / "Services" / "ResearchEvidenceSaveOption.php",
            MODULE / "Hooks" / "ResearchEvidence" / "ResearchEvidenceGovernanceGuard.php",
            MODULE / "Services" / "AIQualificationInsightService.php",
            MODULE / "Services" / "HumanFeedbackService.php",
            MODULE / "Services" / "C21IntelligenceSaveOption.php",
            MODULE / "Hooks" / "AIQualificationInsight" / "AIQualificationInsightImmutableGuard.php",
            MODULE / "Hooks" / "HumanFeedback" / "HumanFeedbackAppendOnlyGuard.php",
            MODULE / "Entities" / "ProspectCandidate.php",
            MODULE / "Entities" / "ProspectRun.php",
            MODULE / "Entities" / "ActionGate.php",
            MODULE / "Entities" / "ExecutionLedger.php",
            MODULE / "Services" / "ActionGateService.php",
            MODULE / "Services" / "ExecutionLedgerService.php",
            MODULE / "Services" / "C22ExecutionSaveOption.php",
            MODULE / "Hooks" / "ActionGate" / "ActionGateDecisionGuard.php",
            MODULE / "Hooks" / "ExecutionLedger" / "ExecutionLedgerAppendOnlyGuard.php",
            ...
            MODULE / "Hooks" / "FeedbackLearningObservation" / "FeedbackLearningObservationImmutableGuard.php",
            MODULE / "Entities" / "ReplySignal.php",
            MODULE / "Services" / "ReplySignalService.php",
            ...
            MODULE / "ProviderBoundary" / "ProviderExecutionRequest.php",
            MODULE / "ProviderBoundary" / "ProviderResultEnvelope.php",
            MODULE / "ProviderBoundary" / "ProviderContract.php",
            MODULE / "ProviderBoundary" / "ConnectorBoundary.php",
            MODULE / "ProviderBoundary" / "ProviderAdapterSkeleton.php",
            MODULE / "Execution" / "ExecutionAction.php",
            MODULE / "Execution" / "ReplyDetectionBoundary.php",
            MODULE / "Services" / "ProspectRunLifecycleService.php",
            MODULE / "Services" / "ExecutionOrchestrationService.php",
            MODULE / "Hooks" / "ProspectRun" / "ProspectRunStatusGuard.php",
            ...
            MODULE / "Controllers" / "SendExecution.php",
