...
$user = $entityManager->getRDBRepository('User')->where(['userName' => 'phase3b04_connector_test'])->findOne();
if (!$user) {
    $user = $entityManager->getEntity('User');
    $user->set('userName', 'phase3b04_connector_test');
}
$user->set('lastName', 'Phase3B04 Connector Test');
$user->set('type', 'api');
$user->set('isActive', true);
$user->set('authMethod', 'ApiKey');
$user->set('apiKey', 'phase3b04-local-test-api-key');
...
echo "PHASE3B04_CONNECTOR_TEST_USER_READY\n";
