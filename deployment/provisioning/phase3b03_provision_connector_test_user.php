...
$user = $entityManager->getRDBRepository('User')->where(['userName' => 'phase3b03_connector_test'])->findOne();
if (!$user) {
    $user = $entityManager->getEntity('User');
    $user->set('userName', 'phase3b03_connector_test');
}
$user->set('lastName', 'Phase3B03 Connector Test');
$user->set('type', 'api');
$user->set('isActive', true);
$user->set('authMethod', 'ApiKey');
$user->set('apiKey', 'phase3b03-local-test-api-key');
...
echo "PHASE3B03_CONNECTOR_TEST_USER_READY\n";
