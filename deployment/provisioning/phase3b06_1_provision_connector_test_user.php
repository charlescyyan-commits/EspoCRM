...
if (!$user) {
    ...
    $user->set('userName', 'phase3b06_1_connector_test');
}
$user->set('lastName', 'Phase3B06.1 Connector Test');
$user->set('type', 'api');
$user->set('isActive', true);
$user->set('authMethod', 'ApiKey');
$user->set('apiKey', 'phase3b06_1-local-test-api-key');
...
echo "PHASE3B06_1_CONNECTOR_TEST_USER_READY\n";
