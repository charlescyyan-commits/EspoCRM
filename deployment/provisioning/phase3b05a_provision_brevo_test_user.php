...
$user = $entityManager->getRDBRepository('User')->where(['userName' => 'phase3b05a_brevo_test'])->findOne();
if (!$user) {
    $user = $entityManager->getEntity('User');
    $user->set('userName', 'phase3b05a_brevo_test');
}
$user->set('lastName', 'Phase3B05A Brevo Test');
$user->set('type', 'api');
$user->set('isActive', true);
$user->set('authMethod', 'ApiKey');
$user->set('apiKey', 'phase3b05a-local-brevo-test-key');
...
echo "PHASE3B05A_BREVO_TEST_USER_READY\n";
